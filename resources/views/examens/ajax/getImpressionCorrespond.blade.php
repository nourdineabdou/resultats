        ...
        <div class="card-header">
            {{ trans('text_me.parametrer_votre_imp_listeCollect') }}
            ...
            <div class="text-right col-md-12">
                ...
                <div class="text-right">
                    <form role="form"  id="formst" name="formst" class=""  method="get" >
                        <div id="divcol">
                            <button type="button"  class="d-none d-sm-inline-block btn btn-sm warning shadow-sm  text-red" onclick="imprimerCorrespontNotes()">{{ trans('text_me.exporterpdf') }}</button>
                        </div>
                        <div id="divind" style="display: none">
                            <button type="button"   class="d-none d-sm-inline-block btn btn-sm warning shadow-sm  text-red" onclick="imprimerListeCorrespondInd()">{{ trans('text_me.exporterpdf') }}</button>
                        </div>
                    </form>
                </div>
            </div>
