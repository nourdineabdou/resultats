<div class="card">
    <div class="card-header">
        {{ trans('text_me.parametrer_votre_imp_listeEmergement1') }}
        ...
        --}}<div class="text-right col-md-12">
            ...
            <div class="text-right">
                <form role="form"  id="formst" name="formst" class=""  method="get" >
                    <div id="divcol">
                        <button type="button"  class="d-none d-sm-inline-block btn btn-sm warning shadow-sm  text-red" onclick="imprimerListeEmergemet1()">{{ trans('text_me.exporterpdf') }}</button>
                    </div>
